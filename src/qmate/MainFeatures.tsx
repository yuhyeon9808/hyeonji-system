      ...
      <div className="font-sans">
        <ul>
          <li className="mt-5">
            ...
            <div className="font-sans pt-3 flex flex-col lg:flex-row gap-x-5 items-start sm:text-14">
              <div className="flex w-full justify-center lg:block lg:w-auto">
                <Image
                  ...
                  width={300}
                  height={535}
                  className="object-contain lg:w-[250px] lg:h-[444px] w-[300px] h-[535px]"
                />
              </div>
              <div className="flex-1 pt-3 lg:pt-0">
                <ul className="leading-7">
                  <li>
                    - 로그인 후 관계 유형(커플/친구)을 선택하며, 커플 관계일
                    경우 기념일을 함께 설정합니다.
                  </li>
                  <li>
                  ...
                  <li>
                    - 연결이 완료된 이후 하루 한 질문으로 생각을 나누고, 일정
                    공유 기능으로 함께한 시간을 기록합니다.
                  </li>
                </ul>
              </div>
            </div>

            <div className="sm:text-14">
              ...
              <div className="flex-1 pt-3 lg:pt-0">
                <ul className="leading-7">
                  ...
                  <li>
                    ...
                    점프하는 상호작용 애니메이션이 재생되어, 사용자와 캐릭터
                    간의 연결감을 높입니다.
                  </li>
                  <li>
                    - 경험치가 일정 수준에 도달하면 캐릭터의 외형이 변화하며,
                    관계의 성장 단계를 시각적으로 표현합니다.
                    <br />
          ...
          <li className="mt-5">
            ...
            <div className="font-sans pt-3 flex flex-col lg:flex-row gap-x-5 items-start sm:text-14">
              ...
              <div className="flex-1 pt-3 lg:pt-0">
                <p className="font-semibold">▶ 질문 발송 & 답변 시스템</p>
                <ul className="mt-2 leading-7">
                  <li>
                    - 매일 기본 설정된 시간에 관리자가 새로운 질문을 발송하며,
                    사용자는 설정 메뉴에서 발송 시간을 직접 변경할 수 있습니다.
                  </li>
                  <li>
                    - 기본 질문 외에도 직접 커스텀 질문을 등록할 수 있으며,
                    등록된 커스텀 질문이 있을 경우 해당 질문이 우선적으로
                    발송됩니다.
                  </li>
                  <li>
                  ...
                  <li>
                    - 수정 가능한 커스텀 질문만 선택적으로 조회할 수 있어 질문
                    관리의 편의성과 개인화된 경험을 제공합니다.
                  </li>
                </ul>

                <hr className="my-5 text-gray-light" />

                <p className="font-semibold">▶ 질문 평가 & 통계</p>
                <ul className="mt-2 leading-7">
                  <li>
                ...
                <p className="font-semibold">▶ 공유 기능</p>
                <ul className="mt-2 leading-7">
                  <li>
                    - 브라우저의 공유 기능을 활용해 답변 이미지를 바로 공유할 수
                    있습니다.
                  </li>
                  <li>
            ...
            <div className="font-sans pt-3 flex flex-col lg:flex-row gap-x-5 items-start sm:text-14">
              ...
              <div className="flex-1 pt-3 lg:pt-0">
                <ul className="leading-7">
                  ...
                  <li>
                    - 관계 유형이 연인으로 설정된 경우, 사귄 날짜를 기준으로
                    100일, N주년, 생일 등의 기념일이 자동 등록되며, 해당 날짜에
                    알림이 발송됩니다. 친구 관계의 경우에는 생일 일정만 자동
                    등록됩니다.
                  </li>
                </ul>
              </div>
